...
import org.lightpaycashj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV lightpaycashj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit lightpaycashj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing lightpaycashj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.lightpaycashj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the lightpaycashj website for further details.
     */
